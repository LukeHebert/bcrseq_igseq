#!/usr/bin/env python3
"""
Takes a .tsv file from MiXCR's exportAlignments function or IgBLAST's AIRR 
output format option and plots the gene usage distribution of either V, D, or J
 segments as an ordered bar plot. It 
